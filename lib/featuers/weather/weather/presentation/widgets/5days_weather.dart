...
class FiveDaysForecast extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        backgroundColor: ColorsConstants.daySecondaryColor,
      ),
      backgroundColor: ColorsConstants.daySecondaryColor,
      body: Column(
        children: [
          ...
          Card(
            child: Container(
              height: ConstantDoubles.d_300,
              width: double.infinity,
              margin:
                  const EdgeInsets.symmetric(horizontal: ConstantDoubles.d_15),
              child: ListView.builder(
                shrinkWrap: true,
                itemCount: list.length,
                itemBuilder: (context, index) => Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: ConstantDoubles.d_15),
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style:
                            Theme.of(context).copyWith().textTheme.displayLarge,
                      ),
                      const Spacer(),
                      ...
                      Padding(
                        padding:
                            const EdgeInsets.only(left: ConstantDoubles.d_20),
                        child: Image.asset(
